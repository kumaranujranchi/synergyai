...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center sm:pt-20 sm:pb-4 lg:pb-6 bg-gradient-to-br from-background via-muted/20 to-background overflow-hidden ml-[0px] mr-[0px] pl-[0px] pr-[0px] pt-[46px] pb-[46px] mt-[4px] mb-[4px]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <Card className="rounded-lg border text-card-foreground shadow-sm p-8 bg-background border-primary/20 mt-[100px] mb-[100px] backdrop-blur-md max-w-5xl mx-auto">
      ...
      <section id="services" className="pt-12 pb-8 sm:pt-16 sm:pb-12 lg:pt-20 lg:pb-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            className="text-center sm:mb-16 mt-[30px] mb-[30px]"
          >
